...
router.put('/api/keys/identity', requireAuth, async (req, res) => {
    try {
...
router.put('/api/keys/signed-prekey', requireAuth, async (req, res) => {
    try {
...
router.post('/api/keys/one-time-prekeys', requireAuth, async (req, res) => {
    try {
...
router.get('/api/keys/one-time-prekeys/count', requireAuth, async (req, res) => {
    try {
...
router.get('/api/keys/bundle/:targetUserId', requireAuth, async (req, res) => {
    try {
...
router.delete('/api/keys', requireAuth, async (req, res) => {
    try {
